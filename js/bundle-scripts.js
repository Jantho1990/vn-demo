...
var _Intro = require('./story/Intro');

var _Intro2 = _interopRequireDefault(_Intro);

var _SapphireCity = require('./story/SapphireCity1');
...
var script = Object.assign({}, _Intro2.default, _SapphireCity2.default);

exports.default = script;

},{"./story/Intro":2,"./story/SapphireCity1":3}],2:[function(require,module,exports){
"use strict";
    ...
    responseToAlicia: {
        ...
        SapphireCity1_Ultimatum: {
            Page: {
                ...
                "Abner chuckled. \"Might as well give it up, Santas. You can't win.\"", "\"Indeed,\" Alicia added, waving her hand once more as I pushed myself back to my feet. \"Might want to think twice before you annoy a sorceress.\"", "I harrumphed and turned away from Alicia. She had manipulated my mind so easily. As other sorcerers and sorceresses from the party gathered in greeting, I couldn't help but wonder in fear what would happen should any one of these powerful humans go rogue...", "end"],
                KlutzMethod: function KlutzMethod(choice) {
                    var ret = "";
                    switch (choice) {
                        case 'gesture':
        ...
        SapphireCity1_DemandExplanation: {
            Page: {
                Content: ["<em>Mind-altering? Did she...did she do something to me?</em>", "\"What did you do?\" I asked.", "She held up her hand, giving me a good look at the ruby-encrusted ring upon her middle finger. \"An ancient item which I am an expert at wielding,\" she explained. \"It's called Erasmo's Ruby Ring, and it grants a user of sufficient ability the power to confound another's mind.\"", "\"Really? That small ring...did that to me?\"", "\"Mmhmm. You still haven't told me your name, by the way.\"", "\"Santas,\" I replied. \"Pleased to meet you.\"", "We shook hands, but I still couldn't forget about how easily she managed to manipulate my mind. As other sorcerers and sorceresses from the party gathered in greeting, I couldn't help but wonder in fear what would happen should any one of these powerful humans go rogue...", "end"]
            }
        },
